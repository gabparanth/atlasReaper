...
function printList(clusters) {
    ...
    clusters.forEach((cluster) => {
        ...
        tblProject.innerHTML = cluster.project.name;
        tblCluster.innerHTML = cluster.name;
        ...
        editConfigurationButton.setAttribute('onclick', `editConfiguration('${cluster._id}','${cluster.project.name}','${cluster.name}','${cluster.whitelistingPolicy}')`);
...
function editConfiguration(id, projectName, clusterName, whitelistingPolicy) {
    ...
    }else if (whitelistingPolicy == "office hours"){
