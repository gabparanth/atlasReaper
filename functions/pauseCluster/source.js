...
exports = function(projectId, clusterName) {
    ...
    return http
      .patch({ url: url, body: {'paused':true}, encodeBodyAsJSON:true })
      .then(resp => {
        ...
        return http.patch({ url: url,  body: {'paused':true}, encodeBodyAsJSON:true, headers: { 'Authorization': [ digestHeader ], "Content-Type": [ "application/json" ] } })
