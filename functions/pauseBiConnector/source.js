...
exports = function(projectId, clusterName) {
    ...
    return http
      .patch({ url: url, body: {"biConnector": {"enabled":false}}, encodeBodyAsJSON:true })
      .then(resp => {
        ...
        return http.patch({ url: url,  body:{"biConnector": {"enabled":false}}	, encodeBodyAsJSON:true, headers: { 'Authorization': [ digestHeader ], "Content-Type": [ "application/json" ] } })
